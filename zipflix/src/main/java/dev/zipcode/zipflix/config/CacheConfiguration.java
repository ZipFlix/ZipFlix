package dev.zipcode.zipflix.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dev.zipcode.zipflix.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dev.zipcode.zipflix.repository.UserRepository.USERS_BY_EMAIL_CACHE);
